...
║  $ python generate_table_config.py dvry_ihs_cotas_ativas dvry_ihs_qualidade_vendas_historico
║  $ python generate_table_config.py --list                                 ║
║  $ python generate_table_config.py --validate table_config_xyz.json      ║
║                                                                           ║
╚═══════════════════════════════════════════════════════════════════════════╝
"""
...
Exemplos:
  ...
  python generate_table_config.py --merge tables_config.json
    ...
    if not args.table_ids:
        ...
        print("\nUse:")
        print("  python generate_table_config.py <table_id> [<table_id2> ...]")
        print("  python generate_table_config.py --list")
        sys.exit(1)
    ...
    print(f"  2. Validar com: python generate_table_config.py --validate table_config_*.json")
    print(f"  3. Mesclar com: python generate_table_config.py --merge")
